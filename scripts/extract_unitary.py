...
input_file = "unitary/retrieved_unitary-hom.npz"   # The file exported from your GUI
output_file = "unitary/retrieved_unitary-hom.npy"   # The new file you want to create
